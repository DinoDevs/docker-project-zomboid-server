...
`MODCHECKERENABLED:` Enables modchecker script that checks whether a mod on the server is updated and restarts the server accordingly. (IMPORTANT: RCON has to be configured and enabled for this to work)
